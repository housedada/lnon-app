...
export const metadata = { title: 'Lavori · Conteggio Orario' };

export default async function JobsHourlyPage({ searchParams }: { searchParams: Promise<JobsListSectionParams> }) {
  ...
  return (
    <div>
      ...
      <RememberRoute storageKey="jobs-tab" tabKey="hourly" />
      ...
      <Suspense fallback={<ListPlaceholder />}>
        <JobsListSection
          category="hourly"
          basePath="/dashboard/jobs/hourly"
          params={params}
          role={role}
