...
export default function DipendenteDashboardPage() {
  const permissions = getUserPermissions('dipendente');
  ...
  return (
    <div>
      <div className="p-6 pb-0">
        <h1 className="text-2xl font-semibold text-neutral-900">Dashboard Dipendente</h1>
        <p className="mt-1 text-sm text-neutral-500">{getRoleDescription('dipendente')}</p>
      </div>
