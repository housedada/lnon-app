  ...
  return (
    ...
    >
      <span
        ref={dragHandleRef}
        {...dragHandleProps}
        className="absolute left-1.5 top-1.5 z-10 flex h-4 w-4 shrink-0 cursor-grab touch-none items-center justify-center active:cursor-grabbing"
      ...
      {editing ? (
        <textarea
          ...
          style={{ paddingLeft: PADDING_LEFT, paddingRight: PADDING_RIGHT, minHeight: 76 }}
        />
      ) : (
        <div
